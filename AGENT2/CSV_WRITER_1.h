...
#ifndef _CSV_WRITER_1_H_
#define _CSV_WRITER_1_H_
...
class FORTE_CSV_WRITER_1: public CFunctionBlock{
  DECLARE_FIRMWARE_FB(FORTE_CSV_WRITER_1)
...
public:
  FUNCTION_BLOCK_CTOR(FORTE_CSV_WRITER_1){
  };

  virtual ~FORTE_CSV_WRITER_1(){};
